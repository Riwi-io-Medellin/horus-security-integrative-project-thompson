...
// ES: Rangos objetivo autorizados por defecto. Ajusta segun tu entorno.
...
// ES: RFC1918 + bloques locales/no enrutable comunes.
...
// ES: Comprobar si una IP objetivo pertenece a los rangos CIDR permitidos.
export function isAuthorizedTarget(ip) {
    return getAuthorizedTargets().some(targetRule => {
        ...
        // EN/ES: Allow exact IPv4 matches in AUTHORIZED_TARGETS.
...
// ES: Determinar si el objetivo pertenece a un rango publico WAN.
